...
namespace CalculatorApp
{
    ...
    private
        enum UnitConverterUnits
        {
            ...
            Length_NauticalLeague = UnitStart + 40,
            Length_Fathom = UnitStart + 41,
            Length_Yard = UnitStart + 42,
            Power_BritishThermalUnitPerMinute = UnitStart + 43,
            Power_FootPoundPerMinute = UnitStart + 44,
            Power_Horsepower = UnitStart + 45,
            Power_Kilowatt = UnitStart + 46,
            Power_Watt = UnitStart + 47,
            Temperature_DegreesCelsius = UnitStart + 48,
            Temperature_DegreesFahrenheit = UnitStart + 49,
            Temperature_Kelvin = UnitStart + 50,
            Time_Day = UnitStart + 51,
            Time_Hour = UnitStart + 52,
            Time_Microsecond = UnitStart + 53,
            Time_Millisecond = UnitStart + 54,
            Time_Minute = UnitStart + 55,
            Time_Second = UnitStart + 56,
            Time_Week = UnitStart + 57,
            Time_Year = UnitStart + 58,
            Speed_CentimetersPerSecond = UnitStart + 59,
            Speed_FeetPerSecond = UnitStart + 60,
            Speed_KilometersPerHour = UnitStart + 61,
            Speed_Knot = UnitStart + 62,
            Speed_Mach = UnitStart + 63,
            Speed_MetersPerSecond = UnitStart + 64,
            Speed_MilesPerHour = UnitStart + 65,
            Volume_CubicCentimeter = UnitStart + 66,
            Volume_CubicFoot = UnitStart + 67,
            Volume_CubicInch = UnitStart + 68,
            Volume_CubicMeter = UnitStart + 69,
            Volume_CubicYard = UnitStart + 70,
            Volume_CupUS = UnitStart + 71,
            Volume_FluidOunceUK = UnitStart + 72,
            Volume_FluidOunceUS = UnitStart + 73,
            Volume_GallonUK = UnitStart + 74,
            Volume_GallonUS = UnitStart + 75,
            Volume_Liter = UnitStart + 76,
            Volume_Milliliter = UnitStart + 77,
            Volume_PintUK = UnitStart + 78,
            Volume_PintUS = UnitStart + 79,
            Volume_TablespoonUS = UnitStart + 80,
            Volume_TeaspoonUS = UnitStart + 81,
            Volume_QuartUK = UnitStart + 82,
            Volume_QuartUS = UnitStart + 83,
            Weight_Carat = UnitStart + 84,
            Weight_Centigram = UnitStart + 85,
            Weight_Decigram = UnitStart + 86,
            Weight_Decagram = UnitStart + 87,
            Weight_Gram = UnitStart + 88,
            Weight_Hectogram = UnitStart + 89,
            Weight_Kilogram = UnitStart + 90,
            Weight_LongTon = UnitStart + 91,
            Weight_Milligram = UnitStart + 92,
            Weight_Ounce = UnitStart + 93,
            Weight_Pound = UnitStart + 94,
            Weight_ShortTon = UnitStart + 95,
            Weight_Stone = UnitStart + 96,
            Weight_Tonne = UnitStart + 97,
